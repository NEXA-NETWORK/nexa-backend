...
export declare namespace CATERC20Structs {
...
export interface CatErc20Interface extends utils.Interface {
  functions: {
    ...
    "initialize(uint16,address,uint8,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [CATERC20Structs.CrossChainPayloadStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BytesLike>,
      CATERC20Structs.SignatureVerificationStruct
    ]
  ): string;
  encodeFunctionData(
...
export interface CatErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CatErc20Interface;
  ...
  functions: {
    ...
    decodeTransfer(
      ...
      [CATERC20Structs.CrossChainPayloadStructOutput] & {
        transfer: CATERC20Structs.CrossChainPayloadStructOutput;
      }
    >;
    ...
    encodeTransfer(
      transfer: CATERC20Structs.CrossChainPayloadStruct,
      overrides?: CallOverrides
    ...
    registerChain(
      ...
      signatureArguments: CATERC20Structs.SignatureVerificationStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  decodeTransfer(
    encoded: PromiseOrValue<BytesLike>,
    overrides?: CallOverrides
  ): Promise<CATERC20Structs.CrossChainPayloadStructOutput>;
