...
async function deploy() {
  ...
  console.log("Deploying Facet Admin with the account:", deployer.address);
  try {
  const FacetName = 'AdminUpdateWormholeFacet'
  ...
  console.log('Deploying facet => ', FacetName)
    ...
    await facetImplement.updateWormhole(config.wormholeBridge);
